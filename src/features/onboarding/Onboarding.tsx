...
export function Onboarding({
  ...
  onLoadGame, onStartNewGame, onFinalizeGame,
  gender, onSetGender,
}: OnboardingProps) {
      ...
      <div className="ob-menu-actions">
        {hasSave ? (
          <>
            ...
            <button className="secondary-button" onClick={startNewGame}>
              ⚓ YENİ OYUN
            </button>
          </>
        ) : (
          <button className="primary-button primary-button--pulse" onClick={startNewGame}>
            ⚓ YENİ OYUN
          </button>
        )}
      </div>
